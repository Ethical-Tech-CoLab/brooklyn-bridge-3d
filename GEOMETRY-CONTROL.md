...
| OQ-016 | How is the tower masonry above the saddle actually arranged, and how wide is the opening the cables pass through? | The width of the cornice opening, and therefore how much of the tower top reads as solid | NYCDOT drawings; SRC-007 plates of the tower tops. SRC-002 establishes that the cables are carried *through* the towers, so the band cannot be solid across them — but nothing read dimensions the opening. |
