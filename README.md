...
*The audit sheet is generated by `tools/photo-survey` from [`digital-3d-shared-contracts`](https://github.com/Ethical-Tech-CoLab/digital-3d-shared-contracts). The 3D viewer here is still a local fork and has not yet adopted the shared `@d3d/bridge-viewer-ui`; see [issue #1](https://github.com/Ethical-Tech-CoLab/brooklyn-bridge-3d/issues/1).*
